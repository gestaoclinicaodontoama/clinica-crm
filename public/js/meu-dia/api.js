// Boilerplate de auth/refresh/retry padrão do projeto (cópia de avaliacao-dentista/api.js).
// Carregado como <script> clássico (não módulo): `request` fica global p/ a página Meu Dia.
const BASE = '/api';
