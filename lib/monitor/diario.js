...
// 'Orçado' criado em 2026-06-08 → cobertura.orcou agora cobre o CRM Novo quando o status é usado.
const STATUS_ETAPA = { Agendado: 'agendou', Compareceu: 'compareceu', 'Orçado': 'orcou', Fechou: 'fechou' };
