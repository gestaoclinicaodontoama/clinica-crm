...
const CONTAS = [
  ...
  { codigo: '6.1', nome: 'Distribuição de lucro — sócios', grupo: '6 - DISTRIBUIÇÃO DE LUCRO', tipo: 'distribuicao', ordem: 90 },
];
...
const GRUPOS_DRE = [
  ...
  { codigo: '6',   titulo: '6 - DISTRIBUIÇÃO DE LUCRO' }, // abaixo do Resultado Final na cascata
];
