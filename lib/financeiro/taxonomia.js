...
const CONTAS = [
  ...
  // (FIXAS_CONTAS em dre-analise.js). Hoje: pró-labore do Marcos + salário fixo do Matheus; Joaquim segue variável em 3.2.1.
  { codigo: '3.2.3', nome: 'Dentistas — fixo mensal',         grupo: '3.2 - MÃO DE OBRA DENTISTA', tipo: 'custo', ordem: 42 },
  ...
  // Provisões (reservas): dinheiro guardado p/ gasto futuro (férias/13º, reforma, lucro).
  // Memorando abaixo do resultado — NÃO é saída de caixa. Ver spec 2026-07-07.
  { codigo: '9.1', nome: 'Provisões', grupo: '9 - PROVISÕES', tipo: 'provisao', ordem: 100 },
];
...
const GRUPOS_DRE = [
  ...
  { codigo: '9',   titulo: '9 - PROVISÕES (reservas)' },  // memorando: reserva, não afeta o resultado
];
