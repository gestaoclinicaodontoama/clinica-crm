...
test('EXPENSES com PersonType=PATIENT NÃO ganha paciente_id (não contamina despesa)', () => {
  const m = mapear({ id: '300', PostType: 'EXPENSES', EntryType: 'ACCOUNTS_PAYMENT',
    Description: 'Pagamento de Conta', Amount: 500, PostDate: '2026-05-03T05:25:24.934Z',
    PersonType: 'PATIENT', PersonId: 123456, RelatedPersonId: -1 });
  assert.equal(m.paciente_id, null);
});
