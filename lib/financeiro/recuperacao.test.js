...
test('pontoDesistencia: empate na moda → menor parcela (independe da ordem de entrada)', () => {
  const items = [
    // T2 primeiro (parou na 3) — se a moda dependesse da ordem, daria 3
    { TreatmentId: 'T2', InstallmentNumber: 0, ReceivedDate: '2026-01-01' },
    { TreatmentId: 'T2', InstallmentNumber: 1, ReceivedDate: '2026-02-01' },
    { TreatmentId: 'T2', InstallmentNumber: 2, ReceivedDate: '2026-03-01' },
    { TreatmentId: 'T2', InstallmentNumber: 3, DueDate: '2026-04-01' },
    // T1 depois (parou na 1)
    { TreatmentId: 'T1', InstallmentNumber: 0, ReceivedDate: '2026-01-01' },
    { TreatmentId: 'T1', InstallmentNumber: 1, DueDate: '2026-02-01' },
  ];
  const r = pontoDesistencia(items, '2026-07-15');
  assert.equal(r.totalTravados, 2);
  assert.equal(r.modaParouEm, 1); // empate 1×1 → menor parcela, não a de entrada mais recente
});
