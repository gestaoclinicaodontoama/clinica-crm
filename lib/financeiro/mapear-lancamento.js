...
function mapear(e) {
  ...
  return {
    ...
    paciente_id: (function () {
      ...
      // Fallback p/ REVENUE (paciente em PersonId). NÃO aplicar a despesas — uma despesa com
      // PersonType=PATIENT não deve virar receita atribuída a paciente.
      if (!ehDespesa && e.PersonType === 'PATIENT' && e.PersonId != null && e.PersonId !== -1) return String(e.PersonId);
      return null;
    })(),
    raw: e,
  };
